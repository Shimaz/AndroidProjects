...
//        SharedPreferences settings = this.getPreferences(MODE_PRIVATE);
        ...
        /* get Values */
        oscIP = "192.168.0.154"; //settings.getString("myIP2", "192.168.0.52");
        oscPort = 3333; //settings.getInt("myPort2", 3333);
        drawAdditionalInfo = false; //settings.getBoolean("ExtraInfo2", false);
        sendPeriodicUpdates = true; //settings.getBoolean("VerboseTUIO2", true);
        screenOrientation = 0; //settings.getInt ("ScreenOrientation2", 0);
        this.adjustScreenOrientation(this.screenOrientation);
        
        touchView  = new TouchView02(this,oscIP,oscPort,drawAdditionalInfo,sendPeriodicUpdates);
...
//        sensorManager = (SensorManager) this.getBaseContext().getSystemService(Context.SENSOR_SERVICE);
        ...
        sBar.setLayoutParams(new LayoutParams(1076, 260));
        sBar.setX(262);
        sBar.setY(2090);
        ...
        sBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
			...
			public void onStartTrackingTouch(SeekBar seekBar) {
				...
				if(touchView.screenSaver == 2){
		    		touchView.screenSaver = 3;
...
//        ImageView btnFake = new ImageView(this);
//        btnFake.setBackgroundResource(R.drawable.img_btn02_pushed);
//        btnFake.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
//        btnFake.setX(848);
//        btnFake.setY(2380);
//        frameLayout.addView(btnFake);
//        
//        
//        
//        
//        Button btnBack = new Button(this);
//        btnBack.setBackgroundResource(R.drawable.btn_01);
...
//	    			
//	    			
//	    			Intent intent = new Intent(MainActivity02.this, LoadActivity.class);
//	    			intent.putExtra("framePort", oscPort);
//	    			intent.putExtra("frameIP", oscIP);
//	    			intent.putExtra("imgKind", 1);
...
//    	myIntent.setClassName("kr.tangomike.frame360.sec201404.alternative", "kr.tangomike.frame360.sec201404.alternative.SettingsActivity"); 
...
//    	Intent myIntent = new Intent();
//     	myIntent.setClassName("kr.tangomike.frame360.sec201404.alternative", "kr.tangomike.frame360.sec201404.alternative.HelpActivity");
//     	showSettings = true;
...
//            	    
//            	    /* define Key/Value */
//            	    editor.putString("myIP2", this.oscIP);
//            	    editor.putInt("myPort2", this.oscPort);
//            	    editor.putBoolean("ExtraInfo2",this.drawAdditionalInfo);
//            	    editor.putBoolean("VerboseTUIO2",this.sendPeriodicUpdates);
//            	    editor.putInt("ScreenOrientation2",this.screenOrientation);
//            	    
//            	    /* save Settings*/
//            	    editor.commit();            	    	        			
//         	    	
...
//    }
    ...
    private void adjustScreenOrientation (int screenOrientation){
    	...
    	switch(screenOrientation){
    		...
    		case 0: this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT);
    		break;
    			
    		case 1: this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT);
    		break;
				
    		case 2: this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT);
    		break;
	
    		default: this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT);
    		break;
    	}	
    }
