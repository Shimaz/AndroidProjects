package kr.tangomike.leeum.yhg.pad_i;
...
//	private RelativeLayout rlContent;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        ivTitle.setImageResource(R.drawable.i_1_title_kor);
...
//					mHandler.sendEmptyMessageDelayed(0, 1000);
	...
	private void setPageContent(int pageNumber, boolean lang){
		...
		if(lang){
			int rID = getResources().getIdentifier("i_" + tmp + "_title_kor", "drawable", getPackageName()); 
	        ...
	        while(true){
	        	...
	        	String ttt = "i_" + tmp + "_text_kor_" + i;
	        	android.util.Log.i("scrl", ttt);
	        	
	        	if(getResources().getIdentifier("i_" + tmp + "_text_kor_" + i, "drawable", getPackageName()) != 0){
	        		ImageView iv = new ImageView(getApplicationContext());
	        		iv.setImageResource(getResources().getIdentifier("i_" + tmp + "_text_kor_" + i, "drawable", getPackageName()));
	        		llContent.addView(iv);
	        		
	        		android.util.Log.i("content", "i_" + tmp + "_text_kor_" + i);
			...
			int rID = getResources().getIdentifier("i_" + tmp + "_title_eng", "drawable", getPackageName()); 
	        ivTitle.setImageResource(rID);
	        
	        
	        int i = 1;
	        while(true){
	        	if(getResources().getIdentifier("i_" + tmp + "_text_eng_" + i, "drawable", getPackageName()) != 0){
	        		ImageView iv = new ImageView(getApplicationContext());
	        		iv.setImageResource(getResources().getIdentifier("i_" + tmp + "_text_eng_" + i, "drawable", getPackageName()));
	        		llContent.addView(iv);
	        		
	        		android.util.Log.i("content", "i_" + tmp + "_text_eng_" + i);
