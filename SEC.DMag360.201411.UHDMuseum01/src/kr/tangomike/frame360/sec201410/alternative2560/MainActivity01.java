...
//        SharedPreferences settings = this.getPreferences(MODE_PRIVATE);
         ...
         * 
         * */
        oscIP = "192.168.0.198";//"192.168.0.154";
        oscPort = 3333;
        drawAdditionalInfo = false;
        sendPeriodicUpdates = true;
        screenOrientation = 0;
        this.adjustScreenOrientation(this.screenOrientation);
        
        touchView  = new TouchView01(this,oscIP,oscPort,drawAdditionalInfo,sendPeriodicUpdates);
...
//        sensorManager = (SensorManager) this.getBaseContext().getSystemService(Context.SENSOR_SERVICE);
        ...
        ivWheel.setX(262 / 2 * MAGNIFY);
        ivWheel.setY(2150 / 2 * MAGNIFY);
        
        frameLayout.addView(ivWheel);
        
        sBar = new SeekBar(this);
        sBar.setLayoutParams(new LayoutParams(1076 / 2 * MAGNIFY, 260 / 2 * MAGNIFY));
        sBar.setX(262 / 2 * MAGNIFY);
        sBar.setY(2090 / 2 * MAGNIFY);
...
//        btnFake.setBackgroundResource(R.drawable.img_btn01_pushed);
...
//        btnBack.setBackgroundResource(R.drawable.btn_02);
//        btnBack.setLayoutParams(new LayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT)));
//        btnBack.setX(848);
//        btnBack.setY(2380);
...
//					isLoading = true;
//					
//					touchView.screenSaver = 2;
////					touchView.sendTUIOdata();
////					touchView.sendTUIOdata();
////					touchView.sendTUIOdata();
////					touchView.sendTUIOdata();
//					
//					Intent intent = new Intent(MainActivity01.this, LoadActivity.class);
//					intent.putExtra("framePort", oscPort);
//					intent.putExtra("frameIP", oscIP);
//					intent.putExtra("imgKind", 2);
